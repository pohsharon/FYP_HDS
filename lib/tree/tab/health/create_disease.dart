  ...
  Future<void> _saveDisease() async {
    ...
    try {
      ...
      if (widget.disease == null) {
        ...
        final diseaseId = widget.disease!['uuid']?.toString() ?? widget.disease!['id']?.toString() ?? '';
      ...
      await Flushbar(
        message: widget.disease != null ? 'Disease updated successfully.' : 'Disease created successfully.',
