...
/// Fruit feature temporarily removed.
///
/// This screen is a placeholder while the harvest/fruit workflow is
/// reimplemented. Restore or replace this file when ready.
class FruitListPage extends StatelessWidget {
	...
	Widget build(BuildContext context) {
		return Scaffold(
			appBar: AppBar(
				title: const Text('Harvest Fruits'),
				...
				child: Padding(
					...
					child: Column(
						...
						children: const [
							...
							SizedBox(height: 16),
							Text(
								'Fruit feature removed',
								style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
							),
							SizedBox(height: 8),
							Text(
								'This screen has been temporarily disabled. Implement a replacement method and restore it here.',
